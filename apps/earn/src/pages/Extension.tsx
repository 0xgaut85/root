...
import { useExtension, useMe } from '../lib/hooks';
  ...
  return (
    <div className="page">
      ...
      <div className="grid grid--main">
        <Card dark>
          <div className="eyebrow">Root extension · v0.1</div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14, lineHeight: 1.55, margin: '0 0 20px', maxWidth: 480 }}>
            The extension relays sealed traffic through your connection and reports verified bytes to your dashboard. It can't read your browsing and never exceeds your allocation.
          </p>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <a className="btn btn--light" href={ZIP} download>
          ...
          <AnimatePresence mode="wait">
            {ext.paired ? (
              ...
              <motion.div key="code" initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                <p className="card__hint" style={{ marginBottom: 12 }}>
                  Open the extension popup and enter this code. Pairing is automatic if you open this page with the extension installed.
                </p>
      ...
      <div className="grid grid--main">
        <Card>
          <CardHead title="Install in 4 steps" hint="Chrome Web Store listing is in review; until then, load it unpacked." />
          <div className="steps">
            <div className="step">
              ...
              <div>
                ...
                <div className="step__d">
                  Download the extension above and unzip it. You'll get a folder called <code>root-network-extension</code>.
                </div>
              </div>
            </div>
            <div className="step">
